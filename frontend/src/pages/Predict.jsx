...
const fields = [
  ...
  { key: 'loan_amount', label: 'Loan Amount ($)', type: 'number', min: 1000 },
  { key: 'credit_score', label: 'Credit Score', type: 'number', min: 300, max: 850 },
  { key: 'employment_years', label: 'Employment Years', type: 'number', min: 0 },
  { key: 'debt_to_income_ratio', label: 'Debt-to-Income Ratio', type: 'number', min: 0, max: 1, step: 0.01 },
  { key: 'num_credit_lines', label: 'Credit Lines', type: 'number', min: 0 },
  { key: 'num_delinquencies', label: 'Past Delinquencies', type: 'number', min: 0 },
]
...
export default function Predict() {
  ...
  const handleChange = (key, val) => setForm(f => ({ ...f, [key]: parseFloat(val) || val }))
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto animate-slide-up">
      <div className="mb-8">
        ...
        <p className="text-muted">Submit an application. Get a decision + SHAP-powered plain-English explanation.</p>
      </div>
        ...
        <div className="bg-panel border border-border rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t border-border">
              <p className="text-xs text-muted font-mono mb-3">DEMOGRAPHIC (bias analysis only — not used in prediction)</p>
          ...
          {result && (
            <div className={`rounded-2xl p-6 border animate-slide-up ${
              ...
              <div className="flex items-center gap-3 mb-4">
                {isRejected
                  ? <XCircle size={28} className="text-crimson" />
              ...
              <div className="bg-black/20 rounded-xl p-3">
                ...
                <div className="h-2 bg-border rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all ${isRejected ? 'bg-crimson' : 'bg-emerald'}`}
            ...
            <div className="bg-panel border border-border rounded-2xl p-6 animate-slide-up">
              ...
              <ResponsiveContainer width="100%" height={220}>
                ...
                >
                  ...
                  <YAxis dataKey="name" type="category" tick={{ fontSize: 10, fill: '#6B7080' }} width={130} />
                  <Tooltip
